...
public class ConfigurationSerialization {
     ...
     * given class. <p> The class must implement
     * {@link ConfigurationSerializable}, including the extra methods as
     * specified in the javadoc of ConfigurationSerializable. <p> If a new
     * instance could not be made, an example being the class not fully
