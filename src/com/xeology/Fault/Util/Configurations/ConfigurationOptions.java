...
public class ConfigurationOptions {
     ...
     * {@link Configuration} directly. <p> If this is true, all values in the
     * default Configuration will be directly copied, making it impossible to
     * distinguish between values that were set and values that are provided by
     * default. As a result,
